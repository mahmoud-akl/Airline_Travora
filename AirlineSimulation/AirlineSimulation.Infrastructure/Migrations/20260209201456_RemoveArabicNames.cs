...
{
    /// <inheritdoc />
    public partial class RemoveArabicNames : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AirlineIcaoCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassengerRole = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoardingTimeUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Terminal = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    Gate = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    BarcodeData = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    BoardingStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomsRate = table.Column<decimal>(type: "decimal(5,4)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BaggageTagId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaggageTags", x => x.BaggageTagId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_FlightId_PassengerId",
                table: "Tickets",
