...
ALTER TABLE [Flights] ADD [ArrivalIataCode] nvarchar(max) NOT NULL DEFAULT N'';

ALTER TABLE [Flights] ADD [DepartureIataCode] nvarchar(max) NOT NULL DEFAULT N'';

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260325190744_AddIataCodeToFlight', N'9.0.0');
